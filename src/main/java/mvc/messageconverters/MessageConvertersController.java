...
public class MessageConvertersController {
	...
	public JavaBean writeXml() {
		return new JavaBean("bar in learn", "apple in");
	}
	...
	public JavaBean writeJson() {
		return new JavaBean("bar self-learn", "apple");
	}
	...
	public String readChannel(@RequestBody Channel channel) {
		return "Read in Channel.. " + channel.getTitle();
	}
	...
	public Channel writeChannel() {
		...
		channel.setDescription("Description self learn...");
		channel.setLink("http://localhost:8080/SpringMVCShowcases/rss");
		return channel;
	}
